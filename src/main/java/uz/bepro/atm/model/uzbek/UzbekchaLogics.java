...
public class UzbekchaLogics {
    ...
    static Card card = new Card("Uzcard", "8600", "Sherjonov Jahongir", "0909", 2000000, true);
    static Card card1 = new Card("Humo", "9860 1234 4555 9012", "Aminov Abror", "0919", 1000, true);
